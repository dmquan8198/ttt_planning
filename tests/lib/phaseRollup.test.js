...
// '5.done' counts toward done_analyst and done_dev_qc too, same as it would
...
test('P1 rollup: cumulative funnel counts and headline % (Done UAT / total)', () => {
  ...
  const tasks = makeTasksByStatus({ '4.ready_for_staging': 4, '5.done': 39 });
