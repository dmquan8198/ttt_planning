...
test('GET /api/sprints/current-next returns current sprint tasks and next sprint tasks', async () => {
  ...
  await pool.query(
    "INSERT INTO tasks (category, name, platform, sprint_id, status, start_date, due_date) VALUES ('Product Foundation','Task A','Web',$1,'2.ready_for_dev','2026-08-03','2026-08-14')",
    [s15.id]
  );
